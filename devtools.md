...
* ⭐ **[Programming / Coding Tutorials](https://fmhy.pages.dev/storage/#coding-tutorials)**
* ⭐ **[Dev YouTube Channels](https://fmhy.pages.dev/storage/#dev-youtube-channels)** - Learn Development / Programming via YouTube
...
* ⭐ **[freeCodeCamp](https://www.freecodecamp.org/)** - Programming / Courses / Interactive [Archive](https://fmhy.pages.dev/base64/#freecodechamp-archive)
* ⭐ **[30 Seconds of Code](https://www.30secondsofcode.org/)** - Find Code Snippets
* ⭐ **[Free Courses by Xemu](https://fmhy.pages.dev/base64/#free-courses-by-xemu)** - Programming Course Drives
* ⭐ **[Phind](https://www.phind.com/)** - Developer Q&A AI
* ⭐ **[Programming Book Sites](https://fmhy.pages.dev/readingpiracyguide/#programming-sites)** - Read / Download Programming Books
...
* [Code With Mosh Courses](https://fmhy.pages.dev/base64/#code-with-mosh-courses)
...
* [Learn SQL](https://sqlbolt.com/) or [Top Database Bundle](https://fmhy.pages.dev/base64/#top-database-bundle) - SQL Lessons
...
* [Java Beginners](https://fmhy.pages.dev/base64/#java-beginners) or [AmigosCode](https://www.youtube.com/@amigoscode) - Java Tutorials
...
* [Modern Python 3 Bootcamp Courses](https://fmhy.pages.dev/base64/#modern-python-3-bootcamp-courses)
...
* [Cyber Security Courses](https://fmhy.pages.dev/base64/#cyber-security-courses) or [Skills for All](https://skillsforall.com/) - Cyber Security Courses
...
* ⭐ **[Developer Tools](https://fmhy.pages.dev/storage/#developer-tools)** - Dev Tool Sites
...
* [Design Resources](https://fmhy.pages.dev/storage/#design-resources) or [Open Source Design](https://opensourcedesign.net/) - Design Resource Sites
* [Image Tools](https://fmhy.pages.dev/img-tools) - Image & Graphic Design Tools
...
* [Icon Download Sites](https://fmhy.pages.dev/storage/#icon-download-sites) - Download Icons for Projects
...
* ⭐ **[Website Creators](https://fmhy.pages.dev/storage/#website-creators)** - Design & Create Websites
* ⭐ **[Free Webhosting Sites](https://fmhy.pages.dev/storage/#free-webhosting-sites)**
* ⭐ **[Site Analytics](https://fmhy.pages.dev/storage/#site-analytics)** - Traffic Stats / Info
...
* [Search Engine Optimization](https://fmhy.pages.dev/storage/#seo-tools) - SEO Tools
...
* [Plunker](https://plnkr.co/) or [Bloo](https://bloouikit.com/) - Prototype / Test Websites Ide
...
* [Canva](https://www.canva.com/), [ThemeKings](http://themekings.net/) or [PikBest](https://pikbest.com/) - Design Templates / [Premium Apk](https://fmhy.pages.dev/base64/#canva-premium) 
...
* [Archive / Scrape / Crawl Webpages](https://fmhy.pages.dev/storage/#web-scraping--archiving-tools) - Archive, Scrape & Crawl Sites 
...
* [w3af](http://w3af.org/) or [Burp](https://fmhy.pages.dev/base64/#burp) - Web App Security Testing
...
* [Wordpress Themes](https://fmhy.pages.dev/storage/#wordpress-themes) - Themes for Wordpress
...
* ⭐ **[Docker Tools](https://fmhy.pages.dev/storage/#docker-tools)** - Docker Tools, Images and Clients
...
* [Free Game Engines](https://fmhy.pages.dev/storage/#game-engines)
...
* [3D Models](https://fmhy.pages.dev/img-tools/#3d-models) - 3D Models / Tools
...
* [Pixel Art Tools](https://fmhy.pages.dev/img-tools/#pixel-art) - Tools to Create Sprites & Pixel Art
...
* ⭐ **[Git Project Indexes](https://fmhy.pages.dev/storage/#git-projects)** 
...
* [GitHub Desktop](https://desktop.github.com/) / [Linux](https://github.com/shiftkey/desktop), [Git-Fork](https://git-fork.com/) or [Tower](https://fmhy.pages.dev/base64/#tower) - Git Clients
...
* ⭐ **[Color Palette Generators](https://fmhy.pages.dev/storage/#color-palette-generators)** - Generate Color Palettes
...
### [Machine Learning](https://fmhy.pages.dev/ai/#machine-learning)
...
* ⭐ **[Code Editors](https://fmhy.pages.dev/storage/#code-editors)** - Code Editing Apps / Sites
